...
permalink: /research/
---
What is the 3D motion of the gas and young stars in the solar neighborhood? How do diffuse interstellar clouds form, evolve, and eventually collapse to form stars and planets? To address these questions, we combine [Large NIR ESO surveys](https://visions.univie.ac.at), ESA [Gaia](https://www.esa.int/Science_Exploration/Space_Science/Gaia), [Herschel](https://www.esa.int/Science_Exploration/Space_Science/Herschel_overview) and [Planck](https://www.esa.int/Science_Exploration/Space_Science/Planck) .
...
The main observational data we use come primarily from ESO facilities in the Atacama desert, ESA space missions, in particular Gaia and JWST. The group is connected to the Vienna node of the A-star consortium and uses A-star Vienna's ScopeSIM for the ESO ELT preparatory science. 
