...
<div class="group-grid">
  ...
  <div class="group-member">
    <img src="/assets/images/group/joao-alves.jpg" alt="João Alves"
         onerror="this.src='/assets/images/group/joao-alves.png'">
    <p class="name">João Alves</p>
    <p class="role">Professor</p>
  </div>

  <div class="group-member">
    <img src="/assets/images/group/stefan-meingast.jpg" alt="Stefan Meingast"
         onerror="this.src='/assets/images/group/stefan-meingast.png'">
...
<!-- <div class="group-grid"> -->
  ...
  <div class="group-member">
    <img src="/assets/images/group/alena-rottensteiner.jpg" alt="Alena Rottensteiner"
         onerror="this.src='/assets/images/group/alena-rottensteiner.png'">
  ...
  <div class="group-member">
    <img src="/assets/images/group/efrem-maconi.jpg" alt="Efrem Maconi"
         onerror="this.src='/assets/images/group/efrem-maconi.png'">
  ...
  <div class="group-member">
    <img src="/assets/images/group/miki-pantaleoni.jpg" alt="Miki Pantaleoni"
         onerror="this.src='/assets/images/group/miki-pantaleoni.png'">
